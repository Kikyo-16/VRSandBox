   ...
   this.animate = (t, room)=> {
      ...
      if(selectedObject == null){
         if(selectedTextureIndex>0){
            selectedObject = room_model.add(objectMeshList[selectedObjectMeshIndex]).color(selectedColor).texture(textureList[selectedTextureIndex]).scale(selectedObjectScale);
         } else {
            selectedObject = room_model.add(objectMeshList[selectedObjectMeshIndex]).color(selectedColor).scale(selectedObjectScale);
         }
