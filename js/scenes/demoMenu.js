...
export const init = async model => {
   ...
   model.move(0,0,0.3).animate(() => {
      ...
      for(let i=0;i<objectList.length;i++){
         objectList[i].turnY(model.time/rotationSpeedDivider).turnX(model.time/rotationSpeedDivider).turnZ(model.time/rotationSpeedDivider);
      }
